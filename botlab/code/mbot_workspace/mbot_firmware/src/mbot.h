...
serial_pose2D_t mbot_odometry_dr = {0}; // DEAD RECKONING ODOMETRY
serial_pose2D_t mbot_simulated_odometry = {0};
serial_mbot_encoders_t mbot_encoders = {0};
serial_twist2D_t mbot_vel = {0};
serial_twist2D_t mbot_vel_dr = {0}; // DEAD RECKONING VELOCITIES
